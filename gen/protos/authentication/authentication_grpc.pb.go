...
const (
	AuthenticationService_Token_FullMethodName                            = "/auth_authentication.AuthenticationService/Token"
	AuthenticationService_Logout_FullMethodName                           = "/auth_authentication.AuthenticationService/Logout"
	AuthenticationService_Decrypt_FullMethodName                          = "/auth_authentication.AuthenticationService/Decrypt"
	AuthenticationService_PasswordOtp_FullMethodName                      = "/auth_authentication.AuthenticationService/PasswordOtp"
	AuthenticationService_PasswordChange_FullMethodName                   = "/auth_authentication.AuthenticationService/PasswordChange"
	AuthenticationService_MqttAuthenticateCacheValidTopics_FullMethodName = "/auth_authentication.AuthenticationService/MqttAuthenticateCacheValidTopics"
)
...
func (c *authenticationServiceClient) Token(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthenticationService_Token_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authenticationServiceClient) Decrypt(ctx context.Context, in *AccessToken, opts ...grpc.CallOption) (*AuthToken, error) {
	out := new(AuthToken)
	err := c.cc.Invoke(ctx, AuthenticationService_Decrypt_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authenticationServiceClient) PasswordOtp(ctx context.Context, in *AccessToken, opts ...grpc.CallOption) (*Code, error) {
	out := new(Code)
	err := c.cc.Invoke(ctx, AuthenticationService_PasswordOtp_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authenticationServiceClient) PasswordChange(ctx context.Context, in *NewPasswordRequest, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, AuthenticationService_PasswordChange_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authenticationServiceClient) MqttAuthenticateCacheValidTopics(ctx context.Context, in *MqttAuthentication, opts ...grpc.CallOption) (*AuthToken, error) {
	out := new(AuthToken)
	err := c.cc.Invoke(ctx, AuthenticationService_MqttAuthenticateCacheValidTopics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthenticationService_Token_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthenticationService_Token_FullMethodName,
	}
...
func _AuthenticationService_Decrypt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthenticationService_Decrypt_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthenticationService_PasswordOtp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthenticationService_PasswordOtp_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthenticationService_PasswordChange_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthenticationService_PasswordChange_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthenticationService_MqttAuthenticateCacheValidTopics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthenticationService_MqttAuthenticateCacheValidTopics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
