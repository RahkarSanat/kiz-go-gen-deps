...
var file_types_types_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x74, 0x79, 0x70, 0x65, 0x73, 0x22, 0x21, 0x0a, 0x09, 0x55, 0x55,
...
var file_types_types_proto_goTypes = []interface{}{
	(*UUIDValue)(nil), // 0: types.UUIDValue
	(*JSONValue)(nil), // 1: types.JSONValue
	(*UUID)(nil),      // 2: types.UUID
	(*InetValue)(nil), // 3: types.InetValue
	(*TimeOnly)(nil),  // 4: types.TimeOnly
	(*BigInt)(nil),    // 5: types.BigInt
}
