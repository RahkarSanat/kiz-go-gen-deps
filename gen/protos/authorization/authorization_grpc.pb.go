...
const (
	AuthorizationService_Can_FullMethodName                    = "/auth_authorization.AuthorizationService/Can"
	AuthorizationService_Grants_FullMethodName                 = "/auth_authorization.AuthorizationService/Grants"
	AuthorizationService_Sanitize_FullMethodName               = "/auth_authorization.AuthorizationService/Sanitize"
	AuthorizationService_SanitizeDecrypted_FullMethodName      = "/auth_authorization.AuthorizationService/SanitizeDecrypted"
	AuthorizationService_MqttTopicAuthorization_FullMethodName = "/auth_authorization.AuthorizationService/MqttTopicAuthorization"
	AuthorizationService_MqttMessageFieldFilter_FullMethodName = "/auth_authorization.AuthorizationService/MqttMessageFieldFilter"
)
...
func (c *authorizationServiceClient) Can(ctx context.Context, in *AuthorizeRequest, opts ...grpc.CallOption) (*AuthorizeResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthorizationService_Can_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authorizationServiceClient) Grants(ctx context.Context, in *AccessRequest, opts ...grpc.CallOption) (*GrantsList, error) {
	out := new(GrantsList)
	err := c.cc.Invoke(ctx, AuthorizationService_Grants_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authorizationServiceClient) Sanitize(ctx context.Context, in *SanitizeRequest, opts ...grpc.CallOption) (*SanitizeResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthorizationService_Sanitize_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authorizationServiceClient) SanitizeDecrypted(ctx context.Context, in *SanitizeDecryptedRequest, opts ...grpc.CallOption) (*SanitizeResponse, error) {
	out := new(SanitizeResponse)
	err := c.cc.Invoke(ctx, AuthorizationService_SanitizeDecrypted_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authorizationServiceClient) MqttTopicAuthorization(ctx context.Context, in *MqttAuthorization, opts ...grpc.CallOption) (*TopicIsAvailable, error) {
	...
	err := c.cc.Invoke(ctx, AuthorizationService_MqttTopicAuthorization_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authorizationServiceClient) MqttMessageFieldFilter(ctx context.Context, in *MqttFieldFilter, opts ...grpc.CallOption) (*ResponseMqttFieldFilter, error) {
	...
	err := c.cc.Invoke(ctx, AuthorizationService_MqttMessageFieldFilter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthorizationService_Can_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthorizationService_Can_FullMethodName,
	}
...
func _AuthorizationService_Grants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthorizationService_Grants_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthorizationService_Sanitize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthorizationService_Sanitize_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthorizationService_SanitizeDecrypted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthorizationService_SanitizeDecrypted_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthorizationService_MqttTopicAuthorization_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthorizationService_MqttTopicAuthorization_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthorizationService_MqttMessageFieldFilter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthorizationService_MqttMessageFieldFilter_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
