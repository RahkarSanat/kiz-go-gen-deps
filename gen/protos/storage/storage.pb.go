...
type EditObjectMetadataRequest struct {
	...
	Metadata map[string]*MetadataOperation `protobuf:"bytes,3,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func file_storage_storage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_storage_storage_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*MetadataOperation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_storage_storage_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*EditObjectMetadataRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_storage_storage_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*EditObjectMetadataResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_storage_storage_proto_msgTypes[12].Exporter = func(v any, i int) any {
